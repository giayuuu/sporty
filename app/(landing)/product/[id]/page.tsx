...
import ProductActions from "../../compenents/product-detail/product-actions";
import priceFormatter from "@/app/utils/price-formatter";

const ProductDetail = () => {
  return (
    <main className="container mx-auto px-15 py-30 flex gap-12">
     <div className="bg-primary-light aspect-square min-w-95 flex justify-center items-center">
        <Image
      ...
      <div className="w-full py-4">
        ...
        <div className="bg-primary-light rounded-full text-primary py-2 px-6 w-fit mb-7">
          Football
        </div>
        ...
        <div className="text-primary text-[32px] font-semibold mb-4">
